# ============================================================
# dags/dubai_transactions_pipeline.py
#
# DAG: dubai_transactions_pipeline
...
DBT_PROJECT    = BASE_DIR / "dbt-dubai" / "smartmove_dubai"
...
with DAG(
    ...
    aas_process_historical = SimpleHttpOperator(
        ...
        data='{"type":"full","objects":[{"database":"SmartMove","table":"fact_transactions_dubai"}]}',
    )
    
    # Executes the pipeline/ml/Dubai/ container image on K3s Server 2
    ...
    aas_process_predicted = SimpleHttpOperator(
        ...
        data='{"type":"full","objects":[{"database":"SmartMove","table":"fact_predictions_dubai"}]}',
    )
