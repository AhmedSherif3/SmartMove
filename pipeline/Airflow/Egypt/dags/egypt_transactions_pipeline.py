# ============================================================
# dags/egypt_transactions_pipeline.py
#
# DAG: egypt_transactions_pipeline
...
DBT_PROJECT    = BASE_DIR / "dbt-egypt" / "smartmove_egypt"
...
with DAG(
    ...
    aas_process_historical = SimpleHttpOperator(
        ...
        data='{"type":"full","objects":[{"database":"SmartMove","table":"fact_transactions_egypt"}]}',
    )
    
    # Executes the pipeline/ml/Egypt/ container image on K3s Server 2
    ...
    aas_process_predicted = SimpleHttpOperator(
        ...
        data='{"type":"full","objects":[{"database":"SmartMove","table":"fact_predictions_egypt"}]}',
    )
