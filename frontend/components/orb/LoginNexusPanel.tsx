...
export default function LoginNexusPanel() {
  ...
  return (
    <section className="relative flex min-h-104 overflow-hidden border-b border-border-subtle bg-linear-to-br from-surface-card via-surface-muted/80 to-surface-page md:sticky md:top-0 md:min-h-screen md:border-b-0 md:border-r">
      <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-brand-primary/20 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -right-16 h-72 w-72 rounded-full bg-brand-accent/20 blur-3xl" />

      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center px-6 pt-4 pb-10 text-center md:ms-2 md:px-10 md:pt-3 md:pb-12">
        <div className="relative -mt-6 flex w-full flex-col items-center justify-center md:-mt-24">
          <div
            ref={panelRef}
          ...
          >
            <NexusOrb
              ...
              nodeCount={32}
              connectionDist={0.72}
              mouseTarget={panelRef}
              onClick={handleOrbClick}
            />
          </div>

          <div className="-mt-32 flex flex-col items-center gap-6">
            <div className="h-40 w-40 overflow-hidden md:h-44 md:w-44">
              <Image
            ...
            <div className="max-w-md">
              <h1 className="font-logo text-4xl font-bold tracking-tight text-content-strong">
                Smart Move
              </h1>
